...
export const headerIntroData = {
  ...
  description: {
    de: "Ich bin John, ein Fullstack-Entwickler mit dem Ziel, meine Karriere voranzutreiben und an inspirierenden Projekten teilzunehmen. Hier präsentiere ich meine Arbeiten und meine Leidenschaft für die Webentwicklung. Lassen Sie uns gemeinsam digitale Lösungen gestalten und die Zukunft formen!",
    en: "I'm John, a fullstack developer with the goal of advancing my career and participating in inspiring projects. Here I present my work and my passion for web development. Let's shape digital solutions together and shape the future!",
  },
  buttons: [
    {
      name: "Contact",
...
export const sideBarLeftSocials = [
  {
    link: "https://github.com/John0486",
    icon: FiGithub,
    altimgname: "github",
  },
  {
...
export const contactData = {
  ...
  privacyOptIn: {
    checkbox: {
      de: "Ich stimme zu, dass John meine personenbezogenen Daten (Name und E-Mail-Adresse) verwenden darf, um mit mir Kontakt aufzunehmen.",
      en: "I agree that John may use my personal data (name and e-mail address) to contact me.",
    },
    description: {
